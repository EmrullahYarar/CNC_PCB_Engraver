# CNC_PCB_Engraver
Simplest DIY CNC engraver for double sided PCBs. The base of project uses grblHAL and the system built on ink printer case. The system works with master and slave stm32 controller for open and closed loop motor control mechaniscms.
